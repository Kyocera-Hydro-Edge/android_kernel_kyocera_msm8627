...
#ifdef FEATURE_KYOCERA_MCAM
static struct gpiomux_setting msm8930_back_cam_settings[] = {
  {
    .func = GPIOMUX_FUNC_1,
    .drv = GPIOMUX_DRV_4MA,
...
static struct msm_gpiomux_config msm8930_back_cam_configs[] = {
  {
    .gpio = 5,
    .settings = {
      [GPIOMUX_ACTIVE]    = &msm8930_back_cam_settings[0],
      [GPIOMUX_SUSPENDED] = &msm8930_back_cam_settings[0],
    },
  },
  {
    .gpio = 54,
    .settings = {
      [GPIOMUX_ACTIVE]    = &msm8930_back_cam_settings[1],
      [GPIOMUX_SUSPENDED] = &msm8930_back_cam_settings[1],
    },
  },
  {
    .gpio = 55,
  ...
  },
  {
    .gpio = 73,
    .settings = {
      [GPIOMUX_ACTIVE]    = &msm8930_back_cam_settings[2],
      [GPIOMUX_SUSPENDED] = &msm8930_back_cam_settings[2],
    },
  },
};
...
#ifdef FEATURE_KYOCERA_MCAM
  {"8038_l9", REG_LDO, 1800000, 1800000, 150000},
  {"8038_lvs2", REG_VS, 1800000, 1800000, 150000},
  {"8038_l17", REG_LDO, 2800000, 2800000, 150000},
#else
...
static struct gpio msm8930_back_cam_gpio[] = {
	...
	{55, GPIOF_DIR_OUT, "CAM_RESET"},
    {73, GPIOF_OUT_INIT_HIGH, "CAM_AFFET"},
#else
	{5, GPIOF_DIR_IN, "CAMIF_MCLK"},
...
#ifdef FEATURE_KYOCERA_MCAM
	{54, GPIOF_OUT_INIT_LOW, 10},
	{54, GPIOF_OUT_INIT_HIGH, 10},
	{55, GPIOF_OUT_INIT_LOW, 10},
	{55, GPIOF_OUT_INIT_HIGH, 10},
#else
...
#ifdef FEATURE_KYOCERA_MCAM
	.cam_gpiomux_conf_tbl = msm8930_back_cam_configs,
	.cam_gpiomux_conf_tbl_size = ARRAY_SIZE(msm8930_back_cam_configs),
#else
	.cam_gpiomux_conf_tbl = msm8930_cam_2d_configs,
	.cam_gpiomux_conf_tbl_size = ARRAY_SIZE(msm8930_cam_2d_configs),
#endif
...
#ifdef FEATURE_KYOCERA_MCAM
static struct msm_camera_csi_lane_params camsensor_main_csi_lane_params = {
  .csi_lane_assign = 0xE4,
  .csi_lane_mask = 0x3,
};

static struct msm_camera_sensor_platform_info sensor_board_info_camsensor_main = {
	.mount_angle = 90,
	.sensor_reset = 54,
	.cam_vreg = msm_8930_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_8930_cam_vreg),
	.gpio_conf = &msm_8930_back_cam_gpio_conf,
	.i2c_conf = NULL,
	.csi_lane_params = &camsensor_main_csi_lane_params,
};
#endif
...
#ifdef FEATURE_KYOCERA_MCAM
	.bus_id         = MSM_8930_GSBI3_QUP_I2C_BUS_ID,
#else
	.bus_id         = MSM_8930_GSBI4_QUP_I2C_BUS_ID,
#endif
	.vcm_pwd        = 0,
...
#ifdef FEATURE_KYOCERA_MCAM
static struct msm_camera_sensor_flash_src back_cam_flash_src = {
  .flash_sr_type = MSM_CAMERA_FLASH_SRC_EXT,
};

static struct msm_camera_sensor_flash_data flash_camsensor_main = {
  .flash_type= MSM_CAMERA_FLASH_LED,
  .flash_src= &back_cam_flash_src
};

struct msm_camera_sensor_info msm_camera_sensor_camsensor_main_data = {
	.sensor_name          = "camsensor_main",
	.pdata                = &msm_camera_csi_device_data[0],
	.flash_data           = &flash_camsensor_main,
	.sensor_platform_info = &sensor_board_info_camsensor_main,
	.csi_if               = 1,
	.camera_type          = BACK_CAMERA_2D,
	.sensor_type          = YUV_SENSOR,
...
#ifdef FEATURE_KYOCERA_MCAM
	{
		I2C_BOARD_INFO("camsensor_main", 0x5A),
		.platform_data = &msm_camera_sensor_camsensor_main_data,
	},
#else
	{
