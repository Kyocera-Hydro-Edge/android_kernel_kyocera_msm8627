...
#define KYOCERA_NOVATEC_VIDEOPANEL
...
#endif
#else
#ifdef KYOCERA_NOVATEC_VIDEOPANEL
		if (!strncmp(name, MIPI_VIDEO_NOVATEK_WVGA_PANEL_NAME,
			strnlen(MIPI_VIDEO_NOVATEK_WVGA_PANEL_NAME, PANEL_NAME_MAX_LEN))){
			return 0;
		}
#endif /* KYOCERA_NOVATEC_VIDEOPANEL */
#endif
...
#endif
#if 1
extern int dev_lcd_panel_power_ctrl( int onoff );
#endif
...
#if 1
	return dev_lcd_panel_power_ctrl(on);
#else
