...
static struct pm8xxx_gpio_init pm8038_gpios[] __initdata = {
	...
	PM8038_GPIO_INIT(1, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(2, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(3, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_UP_30,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),

	PM8038_GPIO_INIT(5, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(6, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(7, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_UP_30,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(8, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_UP_30,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),

	PM8038_GPIO_INIT(10, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(11, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8038_GPIO_INIT(12, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN,
	                 PM8038_GPIO_VIN_L11, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
...
#ifdef QUALCOMM_ORIGINAL_FEATURE
#else /* QUALCOMM_ORIGINAL_FEATURE */
	PM8038_MPP_INIT(5, D_INPUT, PM8038_MPP_DIG_LEVEL_L11, DIN_TO_DBUS2 ),
	PM8038_MPP_INIT(6, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6 , DOUT_CTRL_LOW),
#endif /* QUALCOMM_ORIGINAL_FEATURE */
};
...
static struct pm8xxx_adc_amux pm8038_adc_channels_data[] = {
...
#else
	{"pa_therm1", CHANNEL_NONE, CHAN_PATH_SCALING1, AMUX_RSV1,
#endif
	...
	{"oem_vbat", CHANNEL_VBAT, CHAN_PATH_SCALING2, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
	{"camera_therm", ADC_MPP_1_AMUX6, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_CAMERA_THERM},
};
...
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	...
	.cool_bat_chg_current	= 1000,
	.warm_bat_chg_current	= 1000,
...
#define PM8038_LED_R_MAX_CURRENT	128
#define PM8038_LED_G_MAX_CURRENT	213
#define PM8038_LED_B_MAX_CURRENT	106
#define PM8038_FLASH_MAX_CURRENT	25
#define PM8038_RGB_LED_MAX_CURRENT	12
#endif
...
static struct wled_config_data wled_cfg = {
	...
	.boost_curr_lim = WLED_CURR_LIMIT_385mA,
	.num_strings = 1,
};
...
static struct pm8xxx_led_config pm8038_led_configs[] = {
	...
	[1] = {
		.id = PM8XXX_ID_RGB_LED_RED,
		.mode = PM8XXX_LED_MODE_PWM1,
		.max_current = PM8038_LED_R_MAX_CURRENT,
		.pwm_channel = 5,
		.pwm_period_us = PM8XXX_LED_PWM_PERIOD,
	...
	[2] = {
		.id = PM8XXX_ID_RGB_LED_GREEN,
		.mode = PM8XXX_LED_MODE_PWM1,
		.max_current = PM8038_LED_G_MAX_CURRENT,
		.pwm_channel = 4,
		.pwm_period_us = PM8XXX_LED_PWM_PERIOD,
		.pwm_duty_cycles = NULL,
	},
	[3] = {
		.id = PM8XXX_ID_RGB_LED_BLUE,
		.mode = PM8XXX_LED_MODE_PWM1,
		.max_current = PM8038_LED_B_MAX_CURRENT,
		.pwm_channel = 3,
		.pwm_period_us = PM8XXX_LED_PWM_PERIOD,
		.pwm_duty_cycles = NULL,
	},
	[4] = {
		...
		.mode = PM8XXX_LED_MODE_MANUAL,
		.max_current = PM8038_FLASH_MAX_CURRENT,
	},
	[5] = {
		.id = PM8XXX_ID_RGB_LED_AMBER,
		.mode = PM8XXX_LED_MODE_PWM1,
		.max_current = PM8038_LED_R_MAX_CURRENT,
		.pwm_channel = 5,
		.pwm_period_us = PM8XXX_LED_PWM_PERIOD,
