...
msm8930_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L3, 	 0, 1, 0, 3075000, 3075000, NULL,      0, 0),
	RPM_LDO(L4, 	 1, 1, 0, 1800000, 1800000, NULL,      10000, 10000),
	RPM_LDO(L5, 	 1, 1, 0, 2950000, 2950000, NULL,      0, 0),
	RPM_LDO(L6, 	 0, 1, 0, 2950000, 2950000, NULL,      0, 0),
	RPM_LDO(L7, 	 0, 1, 0, 2050000, 2050000, "8038_s4", 0, 0),
	RPM_LDO(L8, 	 1, 1, 0, 2850000, 2850000, NULL,      0, 0),
	RPM_LDO(L9, 	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L10,	 0, 1, 0, 2900000, 2900000, NULL,      0, 0),
	RPM_LDO(L11,	 1, 1, 0, 1800000, 1800000, "8038_s4", 10000, 10000),
	RPM_LDO(L12,	 0, 1, 0, 1200000, 1200000, "8038_s2", 0, 0),
	RPM_LDO(L13,	 0, 0, 0, 1800000, 2220000, NULL,      0, 0),
	RPM_LDO(L14,	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L15,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	RPM_LDO(L17,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	RPM_LDO(L18,	 0, 1, 0, 2850000, 2850000, NULL,      0, 0),
	RPM_LDO(L20,	 1, 1, 0, 1200000, 1250000, "8038_s2", 10000, 10000),
	RPM_LDO(L21,	 0, 1, 0, 1900000, 1900000, "8038_s4", 0, 0),
	RPM_LDO(L22,	 1, 1, 0, 2950000, 2950000, NULL,      10000, 10000),
	RPM_LDO(L23,	 1, 1, 1, 1800000, 1800000, "8038_s4", 0, 0),
	RPM_LDO(L24,	 0, 1, 1,  500000, 1150000, "8038_s2", 10000, 10000),
	RPM_LDO(L25,	 0, 0, 0, 1300000, 1740000, "8038_l13", 0, 0),
	RPM_LDO(L26,     1, 1, 0, 1050000, 1050000, "8038_s2", 10000, 10000),
