...
#define LOCAL_RAM_ACCESS
#undef LOCAL_RAM_ACCESS

#ifdef LOCAL_RAM_ACCESS
static int l_monkey_stop = 0;
static int l_monkey_cycle = 0;

static char g_monkey_magic[MONKEY_DEVICE_MAGIC_SIZE] = {0};
static int *g_monkey_stop = (int *)&l_monkey_stop;
static int *g_monkey_cycle = (int *)&l_monkey_cycle;
static char g_monkey_log[MONKEY_DEVICE_LOG_SIZE] = {0};
static char g_monkey_file[MONKEY_DEVICE_FILE_SIZE] = {0};
#else /* LOCAL_RAM_ACCESS */
#define MONKEY_DEVICE_BASE_ADDR   (0xFADFF400)
