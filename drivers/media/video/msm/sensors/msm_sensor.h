...
enum msm_sensor_gpio_conf 
{
  MSM_SENSOR_GPIO_CONF_OFF =0,
  MSM_SENSOR_GPIO_CONF_ON
};
#endif
...
#ifdef FEATURE_KYOCERA_MCAM
extern void msm_sensor_vreg_ctl (const char* reg_name, bool onoff, int min_uV, int max_uV);
extern int32_t msm_sensor_gpio_conf (struct msm_sensor_ctrl_t *s_ctrl, enum msm_sensor_gpio_conf gpio_en);
#endif
