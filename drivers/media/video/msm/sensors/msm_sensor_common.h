...
struct msm_sensor_fn_t {
	...
	int32_t (*sensor_write_manual_exposure) (struct msm_sensor_ctrl_t *,uint32_t);
	int32_t (*sensor_start_manual_exposure) (struct msm_sensor_ctrl_t *);
	int32_t (*sensor_stop_manual_exposure) (struct msm_sensor_ctrl_t *);
#endif
...
#ifdef FEATURE_KYOCERA_MCAM
	int32_t (*sensor_set_white_balance) (struct msm_sensor_ctrl_t *, uint16_t);
	int32_t (*sensor_set_manual_iso) (struct msm_sensor_ctrl_t *, uint16_t);
	int32_t (*sensor_set_ae_mode) (struct msm_sensor_ctrl_t *, uint16_t);
	int32_t (*sensor_set_scene_mode) (struct msm_sensor_ctrl_t *, uint16_t);
	int32_t (*sensor_get_exif_info) (struct msm_sensor_ctrl_t *, struct exif_info_sensor_t *);
	int32_t (*sensor_set_focus_mode) (struct msm_sensor_ctrl_t *, uint16_t);
	int32_t (*sensor_get_flash_info) (struct msm_sensor_ctrl_t *, struct flash_info_sensor_t *);
	int32_t (*sensor_get_ae_awb_stable_info) (struct msm_sensor_ctrl_t *, struct ae_awb_stable_info_sensor_t *);
	int32_t (*sensor_set_flash_reg) (struct msm_sensor_ctrl_t *, uint32_t);
    void (*sensor_cancel_focus)(void);
#endif
#ifdef FEATURE_KYOCERA_MCAM
	int32_t (*sensor_set_roi_af_area_info) (struct msm_sensor_ctrl_t *, struct roi_af_area_info_sensor_t *);
	int32_t (*sensor_set_roi_ae_area_info) (struct msm_sensor_ctrl_t *, struct roi_ae_area_info_sensor_t *);
#endif
#ifdef FEATURE_KYOCERA_MCAM
	int32_t (*sensor_start_caf_takepicture) (struct msm_sensor_ctrl_t *);
#endif
};
