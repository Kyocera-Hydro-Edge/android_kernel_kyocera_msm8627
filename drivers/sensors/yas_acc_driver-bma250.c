...
#define YAS_BMA250_DEFAULT_POSITION                                             5
...
static int yas_calibration(struct yas_acc_data *data)
{
	/* not support. */
	return YAS_NO_ERROR;
}
...
static int yas_get_odr(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_odr(int odr)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_get_cal_mode(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_mode(int mode)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_get_cal_state(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_state(int state)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_get_cal_wait(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_wait(int wait)
{
	(void)wait;
	/* not support. */
	return YAS_NO_ERROR;
...
static int yas_get_cal_smp_n(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_smp_n(int smp_n)
{
	(void)smp_n;
	/* not support. */
	return YAS_NO_ERROR;
...
static int yas_get_cal_ave_n(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_ave_n(int ave_n)
{
	(void)ave_n;
	/* not support. */
	return YAS_NO_ERROR;
...
static int yas_get_cal_flt_en(void)
{
	/* not support. */
	return YAS_NO_ERROR;
}

static int yas_set_cal_flt_en(int flt_en)
{
	(void)flt_en;
	/* not support. */
	return YAS_NO_ERROR;
...
int yas_acc_driver_init(struct yas_acc_driver *f)
{
	...
	f->get_odr = yas_get_odr;
	f->set_odr = yas_set_odr;
	f->get_cal_mode = yas_get_cal_mode;
	f->set_cal_mode = yas_set_cal_mode;
	f->get_cal_state = yas_get_cal_state;
	f->set_cal_state = yas_set_cal_state;
	f->get_cal_wait = yas_get_cal_wait;
	f->set_cal_wait = yas_set_cal_wait;
	f->get_cal_smp_n = yas_get_cal_smp_n;
	f->set_cal_smp_n = yas_set_cal_smp_n;
	f->get_cal_ave_n = yas_get_cal_ave_n;
	f->set_cal_ave_n = yas_set_cal_ave_n;
	f->get_cal_flt_en = yas_get_cal_flt_en;
	f->set_cal_flt_en = yas_set_cal_flt_en;
	f->calibration = yas_calibration;
