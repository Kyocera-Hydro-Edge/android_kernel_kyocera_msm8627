...
#define MSMFB_MIPI_REG_WRITE  _IOW( MSMFB_IOCTL_MAGIC, 200, struct disp_diag_mipi_reg_type)
#define MSMFB_MIPI_REG_READ   _IOWR(MSMFB_IOCTL_MAGIC, 201, struct disp_diag_mipi_reg_type)
#define MSMFB_DISPLAY_STANDBY _IOW( MSMFB_IOCTL_MAGIC, 202, unsigned int)

#define MSMFB_CRC_GET         _IOR( MSMFB_IOCTL_MAGIC, 203, uint32_t)
#define MSMFB_CRC_RESET       _IOW( MSMFB_IOCTL_MAGIC, 204, unsigned int)

#define MSMFB_CHANGE_TRANSFER_RATE  _IOW(MSMFB_IOCTL_MAGIC, 205, uint32_t)

#define MSMFB_LCD_BACKLIGHT   _IOW(MSMFB_IOCTL_MAGIC, 206, unsigned int)
