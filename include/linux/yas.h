...
struct yas_acc_driver {
	...
	int (*get_odr)(void);
	int (*set_odr)(int odr);
	int (*get_cal_mode)(void);
	int (*set_cal_mode)(int mode);
	int (*get_cal_state)(void);
	int (*set_cal_state)(int state);
	int (*get_cal_wait)(void);
	int (*set_cal_wait)(int wait);
	int (*get_cal_smp_n)(void);
	int (*set_cal_smp_n)(int smp_n);
	int (*get_cal_ave_n)(void);
	int (*set_cal_ave_n)(int ave_n);
	int (*get_cal_flt_en)(void);
	int (*set_cal_flt_en)(int flt_en);
	int (*calibration)(struct yas_acc_data *data);
...
struct yas_gyro_driver {
	...
	int (*get_calbretion_mode)( void );
	int (*set_calbretion_mode)( int mode );
	int (*get_cal_sample_num)( void );
	int (*set_cal_sample_num)( int num );
	int (*get_acc_calbretion)( void );
	int (*set_acc_calbretion)( int acc_calbretion );
	int (*get_acc_cal_thershold)( void );
	int (*set_acc_cal_thershold)( int acc_thershold );
	int (*get_gyro_cal_thershold)( void );
	int (*set_gyro_cal_thershold)( int gyro_thershold );
	int (*get_gyro_filter_setting)( void );
	int (*set_gyro_filter_setting)( int setting );
	int (*set_x_offset)( int x_offset );
	int (*set_y_offset)( int y_offset );
	int (*set_z_offset)( int z_offset );
	int (*set_x_senc_offset)( int x_offset );
	int (*set_y_senc_offset)( int y_offset );
	int (*set_z_senc_offset)( int z_offset );
	int (*get_iir_filter)( void );
	int (*set_iir_filter)( int iir );
	double (*get_filter_b0)( void );
	int (*set_filter_b0)( double filter );
	double (*get_filter_b1)( void );
	int (*set_filter_b1)( double filter );
	double (*get_filter_b2)( void );
	int (*set_filter_b2)( double filter );
	double (*get_filter_a1)( void );
	int (*set_filter_a1)( double filter );
	double (*get_filter_a2)( void );
	int (*set_filter_a2)( double filter );
	int (*get_filter_value)( void );
	int (*set_filter_value)( int filter_val );
